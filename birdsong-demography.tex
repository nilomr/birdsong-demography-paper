...
\begin{figure*}[!ht]
    ...
    \mycaption{Study system and main variables in our analysis}{
        ...
        (C) 3D render of our study site, Wytham Woods, based on first return LiDAR data \parencite{defra2020} and made with \href{https://github.com/tylermorganwall/rayshader}{rayshader}. Elevation is exaggerated. The network represents pairwise repertoire similarity between individuals with known spatial locations, used in the models reported in Fig. 2. Aquamarine (darker) arrows represent natal dispersal within the population, and the yellow (lighter) arrow represents immigration into the population, two of the variables used in this work. Age and bird (individual) turnover are not depicted.        
    }
    \label{c4_fig:main}
\end{figure*}
